...
electron.contextBridge.exposeInMainWorld("electronAPI", {
  ...
  onMapExtractionStatus: (callback) => {
    electron.ipcRenderer.on("map-extraction-status", (_event, status) => {
      callback(status);
    });
  },
  getAvailableMaxZoom: () => electron.ipcRenderer.invoke("get-available-max-zoom")
});
